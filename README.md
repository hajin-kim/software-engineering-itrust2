...
- XP를 상당 부분 채용합니다. XP의 약점인 요구사항의 변동, 충돌, 미발견, 비정형성이 발생하지 않는 상황이기 때문입니다.
- 폭포수는 플래닝 및 설계 역량이 부족한 상황에서 적합하지 않다고 봅니다.
- 스크럼은 요구사항 변동이 없고, 각자 활동 시간이 비동기적인 상황에서 적합하지 않다고 봅니다.
- 개발 주기: 플래닝 -> 모델링 -> 개발 -> 피드백
...
개발자에게 회고는 매우 중요합니다. 피드백을 통해 성장의 밑거름을 마련하기 때문입니다. Iteration 1 직후 조직별로 진행할 예정입니다.
