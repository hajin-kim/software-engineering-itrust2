...
public class OfficeVisitTest {
    ...
    @Autowired private BasicHealthMetricsService basicHealthMetricsService;
    ...
    public void setup() {
        ...
        final User alice =
                new Patient(new UserForm("AliceThirteen", "123456", Role.ROLE_PATIENT, 1));
    ...
    public void testOfficeVisit() {
        ...
        final Hospital hosp =
                new Hospital("Dr. Jenkins' Insane Asylum", "123 Main St", "12345", "NC");
